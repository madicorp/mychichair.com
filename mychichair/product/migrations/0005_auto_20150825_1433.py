...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='product',
            name='weight',
            field=mychichair.product.models.fields.WeightField(verbose_name='weight', max_digits=6, decimal_places=2, unit='lb'),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            ...
            field=mychichair.product.models.fields.WeightField(verbose_name='weight override', decimal_places=2, blank=True, max_digits=6, unit='lb', null=True),
        ),
        migrations.AlterField(
            model_name='stock',
            name='cost_price',
