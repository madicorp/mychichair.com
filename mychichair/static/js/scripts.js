    ...
    $(function () {
        ...
        (function () {
            globalDfd.done(function () {
                ...
                $('.testiomials_carousel .animate_ftr:first').waypointInit('animate_horizontal_finished', '851px',
                                                                           1200);
                $('.testiomials_carousel .animate_ftr:nth-child(2)').waypointInit('animate_horizontal_finished',
                                                                                  '973px', 1400);
                $('.testiomials_carousel .animate_ftr:nth-child(3)').waypointInit('animate_horizontal_finished',
                                                                                  '987px', 1600);
        ...
        if ($('.r_slider').length) {
            ...
            api.bind("revolution.slide.onloaded", function (e, data) {
                ...
                (function () {
                    ...
                    for (var i = 0; i < len; i++) {
                        bullet.eq(i).append(
                            '<div class="custom_thumb tr_all_hover"><img src="' + image.eq(i).data('custom-thumb') +
                            '" alt=""></div>');
                    }
                })();
            ...
            if (cs.length) {
                ...
                cs.camera({
                              ...
                              onLoaded: function () {
                                  ...
                                  for (var i = 0; i < len; i++) {
                                      bullet.eq(i).append('<div class="custom_thumb tr_all_hover"><img src="' +
                                                          image.eq(i).data('custom-thumb') + '" alt=""></div>');
                                  }
        ...
        (function () {
            if ($('.product_brands').length) {
                var pb = $(".product_brands").owlCarousel({
                                                              itemsCustom: $('.product_brands').hasClass(
                                                                  'with_sidebar') ? [[1199, 4], [992, 4], [768, 3],
                                                                  [480, 3], [300, 2]] : [[1199, 6], [992, 5], [768, 4],
                                                                  [480, 3], [300, 2]],
                                                              autoPlay: true,
                                                              stopOnHover: true,
                                                              slideSpeed: 600,
        ...
        window.rmenu = function () {
            ...
            rMenu.checkWindowSize = function () {
                ...
                if ($(window).width() + rMenu.scrollWidth < 768) {
                    rMenu.Activate();
                    nav.find('.touch_open_sub,.current_click').removeClass('touch_open_sub current_click').children(
...
// remove click events
            rMenu.Deactivate = function () {
                ...
                if ($('html').hasClass('md_touch')) {
                    header.off('click').on('click.touch', '.main_menu li a',
                                           rMenu.touchOpenSubMenu);
                }
            ...
            rMenu.touchOpenSubMenu = function (event) {
                ...
                if (self.next('.sub_menu_wrap').length) {
                    ...
                    $(this).parent().toggleClass('touch_open_sub').siblings().removeClass('touch_open_sub').children(
                        'a').removeClass('prevented')
                           .parent().find('.touch_open_sub').removeClass('touch_open_sub').children('a').removeClass(
                        'prevented');
            ...
            $('.custom_select').each(function () {
                ...
                if ($(this).find('[data-filter]').length) {
                    for (var i = 0, len = select.children('option').length; i < len; i++) {
                        list.append('<li data-filter="' + select.children('option').eq(i).data('filter') +
                                    '" class="tr_delay_hover">' + select.children('option').eq(i).text() + '</li>')
                    }
                }
                else {
                    for (var i = 0, len = select.children('option').length; i < len; i++) {
        ...
        (function () {
            ...
            $('#id_variant').children('option:selected').each(function (idx, option) {
                $('.quantity').children('input[type="text"]').attr('max', $(option).attr('max'));
            });
            $('.quantity').on('click', 'div', function () {
                var data = $(this).data('direction'),
                    i = $(this).parent().children('input[type="text"]'),
                    val = i.val();
                var maxValue = !!i.attr('max') ? Number(i.attr('max')) : -1;
                if (data == "up" && (maxValue > 1 || val < maxValue)) {
                    val++;
                    i.val(val);
                } else if (data == "down") {
                    if (val == 1) {
        ...
        (function () {
            ...
            $('#id_variant').change(function () {
                ...
                $('#id_quantity').attr('max', selectedOption.attr('max'));
            });
        ...
        (function () {
            ...
            if (rp.length) {
                var qv = rp.owlCarousel({
                                            itemsCustom: rp.hasClass("product_full_width") ? [[1199, 4], [992, 4],
                                                [768, 3], [480, 1], [300, 1]] : [[1199, 3], [992, 3], [768, 3],
                                                [480, 1], [300, 1]],
                                            autoPlay: false,
                                            slideSpeed: 1000,
                                            autoHeight: true
                ...
                request.then(function (data) {
                    if (data == "1") {
                        ...
                        $('.message_container').html(
                            '<div class="alert_box r_corners color_green success"><i class="fa fa-smile-o"></i><p>' +
                            text + '</p></div>')
                                               .delay(150)
                                               .slideDown(300)
                                               .delay(4000)
                        ...
                        $('.message_container').html(
                            '<div class="alert_box r_corners error"><i class="fa fa-exclamation-triangle"></i><p>' +
                            text + '</p></div>')
                                               .delay(150)
                                               .slideDown(300)
                                               .delay(4000)
                    ...
                    $('.message_container').html(
                        '<div class="alert_box r_corners error"><i class="fa fa-exclamation-triangle"></i><p>Connection to server failed!</p></div>')
                                           .delay(150)
                                           .slideDown(300)
                                           .delay(4000)
                                           .slideUp(300, function () {
        ...
        (function () {
            ...
            subscribe.on('submit', function (e) {
                ...
                if (self.find('input[type="email"]').val() == '') {
                    ...
                    message.html(
                        '<div class="alert_box r_corners error"><i class="fa fa-exclamation-triangle"></i><p>' + text +
                        '</p></div>')
                           .slideDown()
                           .delay(4000)
                           .slideUp(function () {
        ...
        (function () {
            ...
            dp.each(function () {
                ...
                self.text(self.text().substr(1)).prepend(
                    '<span class="fl r_corners t_align_c f_left d_block">' + fl + '</span>');
            });
