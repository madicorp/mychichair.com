...
from mychichair.order.models import Order
from mychichair.registration.models import EmailChangeRequest
...
def test_address_without_shipping(request_cart_with_item, client, monkeypatch):  # pylint: disable=W0613
    ...
    monkeypatch.setattr('mychichair.checkout.core.Checkout.is_shipping_required',
                        False)
...
def test_summary_without_shipping_method(request_cart_with_item, client, monkeypatch):  # pylint: disable=W0613
    ...
    monkeypatch.setattr('mychichair.checkout.core.Checkout.email',
                        True)
