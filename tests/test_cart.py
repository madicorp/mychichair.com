...
from mychichair.cart import decorators, forms, utils
from mychichair.cart.context_processors import cart_counter
from mychichair.cart.models import Cart
...
def test_cart_counter(monkeypatch):
    monkeypatch.setattr('mychichair.cart.context_processors.get_cart_from_request',
...
def test_get_user_open_cart_token(monkeypatch):
    monkeypatch.setattr('mychichair.cart.models.Cart.get_user_open_cart',
...
def test_check_product_availability_and_warn(
    ...
    monkeypatch.setattr('django.contrib.messages.warning',
                        Mock(warning=Mock()))
    monkeypatch.setattr('mychichair.cart.utils.contains_unavailable_variants',
    ...
    monkeypatch.setattr('mychichair.cart.utils.remove_unavailable_variants',
...
def test_replace_cartline_form_when_insufficient_stock(
    ...
    monkeypatch.setattr('mychichair.product.models.ProductVariant.check_quantity',
